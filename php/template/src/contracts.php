            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                                            ...
                                            <div class="filter-content-list bg-light rounded border p-2 shadow mt-2">
                                                ...
                                                <ul class="mb-0">
                                                    <li class="mb-1">
                                                        <label class="dropdown-item px-2 d-flex align-items-center">
                                                            <input class="form-check-input m-0 me-1" type="checkbox">
                                                            <span class="avatar avatar-xss rounded-circle me-1"><img src="assets/img/company/company-01.svg" class="flex-shrink-0 rounded-circle" alt="img"></span>NovaWave LLC
                                                        </label>
                                                    </li>
                                                        <li class="mb-1">
                                                        <label class="dropdown-item px-2 d-flex align-items-center">
                                                            <input class="form-check-input m-0 me-1" type="checkbox">
                                                            <span class="avatar avatar-xss rounded-circle me-1"><img src="assets/img/company/company-02.svg" class="flex-shrink-0 rounded-circle" alt="img"></span>BlueSky Industries
                                                        </label>
                                                    </li>
                                                    <li class="mb-1">
                                                        <label class="dropdown-item px-2 d-flex align-items-center">
                                                            <input class="form-check-input m-0 me-1" type="checkbox">
                                                            <span class="avatar avatar-xss rounded-circle me-1"><img src="assets/img/company/company-03.svg" class="flex-shrink-0 rounded-circle" alt="img"></span>Silver Hawk
                                                        </label>
                                                    </li>
                                                </ul>
                                            </div>
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">                                                 
                    <div class="d-flex align-items-center shadow p-1 rounded border bg-white view-icons">
                        <a href="contracts-list.php" class="btn btn-sm p-1 border-0 fs-14"><i class="ti ti-list-tree"></i></a>
                        <a href="contracts.php" class="flex-shrink-0 btn btn-sm active p-1 border-0 ms-1 fs-14"><i class="ti ti-grid-dots"></i></a>
                    </div>
