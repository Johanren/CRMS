                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-2">
                                ...
                                <img src="assets/img/users/avatar-10.jpg" class="avatar-lg w-auto rounded-pill" alt="rounded-pill">
                            </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <p class="text-muted">Use <code>z-index</code> utilities to stack elements on top of one another. Requires a <code>position</code> value other than <code>static</code>, which can be set with custom styles or using our <a href="/docs/5.3/utilities/position/">position utilities</a>.</p>
