                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <nav>
                                <ul class="pagination pagination-boxed flex-wrap gap-lg-0 gap-md-0 gap-1">
                                    <li class="page-item">
                                        <a class="page-link" href="javascript:void(0);" aria-label="Previous">
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <nav>
                                <ul class="pagination pagination-sm pagination-boxed flex-wrap gap-lg-0 gap-md-0 gap-1">
                                    <li class="page-item">
                                        <a class="page-link" href="javascript:void(0);" aria-label="Previous">
                                            <span aria-hidden="true">&laquo;</span>
                                        </a>
