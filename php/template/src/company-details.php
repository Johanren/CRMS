        ...
        <div class="content pb-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        <a href="companies.php"><i class="ti ti-arrow-narrow-left me-1"></i>Back to Companies</a>
                    </div>
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="border-bottom mb-3 pb-3">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <p class="mb-0">novawave@gmail.com</p>
                                </div>
                                <div class="d-flex align-items-center mb-2">
                                    <span class="avatar avatar-xs bg-light p-0 flex-shrink-0 rounded-circle text-dark me-2">
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center">
                                    <span class="avatar avatar-lg rounded-circle me-2 border">
                                        <img src="assets/img/icons/company-icon-04.svg" alt="Img" class="img-fluid w-auto h-auto">
                                    </span>
                                    <div>
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center">
                                    <span class="avatar avatar-lg rounded-circle me-2 border">
                                        <img src="assets/img/icons/company-icon-05.svg" alt="Img" class="img-fluid w-auto h-auto">
                                    </span>
                                    <div>
