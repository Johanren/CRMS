                ...
                <div class="col-sm-12">
                    <div>
                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                            ...
                            <a href="add-invoices.php" class="btn btn-md btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Invoices</a>
                        </div>
                                ...
                                <table class="table table-nowrap border">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-1454</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                        <img src="assets/img/users/user-01.jpg" class="rounded-circle" alt="user">
                                                    </a>
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Anthony Lewis</a>
                                                        </h6>
                                            ...
                                            <td>
                                                <div class="d-inline-flex align-items-center">
                                                    <a href="invoice-details.php" class="btn btn-icon btn-sm btn-outline-white border-0"><i class="ti ti-eye"></i></a>
                                                    <a href="edit-invoices.php" class="btn btn-icon btn-sm btn-outline-white border-0"><i class="ti ti-edit"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-6571</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Brian Villalobos</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-2245</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Harvey Smith</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-1456</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Stephan Peralt</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-0045</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Doglas Martini</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-6244</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Linda Ray</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-9565</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Elliot Murray</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-6874</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Rebecca Smtih</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-6587</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Connie Waters</a>
                                                        </h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="invoice-details.php">INV-5879</a>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="invoice-details.php" class="avatar avatar-sm me-2">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-medium mb-0 fs-14"><a href="invoice-details.php">Lori Broaddus</a>
                                                        </h6>
