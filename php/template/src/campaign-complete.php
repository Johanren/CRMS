        ...
        <div class="content pb-0">
            ...
            <div class="campaign-tab">
                <ul class="nav nav-tabs nav-bordered mb-4">
                    <li class="nav-item">
                        <a href="campaign.php" class="nav-link bg-transparent">Active Campaign<span class="fs-10 fw-normal ms-1 text-body">24</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="campaign-complete.php" class="nav-link active bg-transparent text-primary">Completed Campaign</a>
                    </li>
                    <li class="nav-item">
