            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">                                
                    <div class="d-flex align-items-center shadow p-1 rounded border view-icons bg-white">
                        <a href="estimations-list.php" class="btn btn-sm p-1 border-0 fs-14"><i class="ti ti-list-tree"></i></a>
                        <a href="estimations.php" class="flex-shrink-0 btn btn-sm p-1 border-0 ms-1 fs-14 active"><i class="ti ti-grid-dots"></i></a>
                    </div>
                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);"
                                                class="avatar rounded-circle border bg-white flex-shrink-0 me-2">
                                                <img src="assets/img/priority/project-02.svg"
                                                    class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                                <h6 class="fw-medium fs-14 mb-1"><a
