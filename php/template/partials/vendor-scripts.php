...
<?php if ($page == 'deals.php' || $page == 'estimations.php' || $page == 'leads.php' || $page == 'rst_frm.php' || $page == 'rst_frm_dia.php') {   ?>
    <!-- Drag Card -->
...
<?php if ($page == 'leads-list.php' || $page == 'leads.php' || $page == 'leads-details.php' || $page == 'contacts.php' || $page == 'rst_frm.php' || $page == 'rst_frm_dia.php') {   ?>
