...
?>
    ...
    <script src="assets/json/notificacion.js"></script>
    <script>
...
<?php if ($page == 'deals.php' || $page == 'estimations.php' || $page == 'leads.php' || $page == 'rst_frm.php' || $page == 'reporte_fuente.php' || $page == 'rst_frm_dia.php' ) {   ?>
    <!-- Drag Card -->
...
<?php if ($page == 'leads-list.php' || $page == 'leads.php' || $page == 'reporte_fuente.php' || $page == 'leads-details.php' || $page == 'contacts.php' || $page == 'rst_frm.php' || $page == 'rst_frm_dia.php') {   ?>
...
<?php if ($page == 'rst_frm.php' || $page == 'rst_frm_dia.php' || $page == 'lead_dia.php') {   ?>
    <script src="assets/json/rst_frm.js"></script>
<?php } ?>

<?php if ($page == 'rst_frm_teo.php') {   ?>
    <script src="assets/json/rst_frm_teo.js"></script>
<?php } ?>
...
<?php if ($page == 'info_origen.php' || $page == 'lead_dia.php' || $page == 'reporte_estado_lead.php' || $page == 'reporte_lead.php' || $page == 'campanas.php' || $page == 'resultado_foco.php' || $page == 'index.php' || $page == 'rst_frm_dia.php' || $page == 'reporte_fuente.php' || $page == 'rst_frm.php' || $page == 'leads.php' || $page == 'venta.php' || $page == 'leads-list.php' || $page == 'leads-details.php' || $page == 'contacts.php' || $page == 'lead-reports.php' || $page == 'ciudad.php' || $page == 'barrio.php' || $page == 'programa.php' || $page == 'jornada.php' || $page == 'interes.php' || $page == 'medio.php' || $page == 'fuente.php' || $page == 'accion.php' || $page == 'rst_frm_dia.php' || $page == 'rst_frm.php') {   ?>
    <script src="assets/json/venta.js"></script>
    <script src="assets/json/ciudad.js"></script>
    <script src="assets/json/barrio.js"></script>
    <script src="assets/json/carrera.js"></script>
    <script src="assets/json/horario.js"></script>
    <script src="assets/json/interes.js"></script>
    <script src="assets/json/medio.js"></script>
    <script src="assets/json/fuente.js"></script>
    <script src="assets/json/accion.js"></script>
    <script src="assets/json/info_origen.js"></script>
    <script src="assets/json/manage-users-list.js"></script>
    <script src="assets/json/roles-list.js"></script>
    <script src="assets/json/campanas.js"></script>
<?php } ?>
